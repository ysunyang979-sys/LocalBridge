...
export class ConnectionService {
  ...
  createOrUpdateConnection(input: Partial<AIConnectionConfig> & { id: string; clientType: AIClientType; name: string }): AIConnectionDto {
    ...
    const rowParam = {
      ...
      transport: input.transport || (input.clientType === "chatgpt" ? "tunnel" : "http"),
      endpoint: input.endpoint || (input.clientType === "deepseek" ? "https://api.deepseek.com" : "http://127.0.0.1:18080/mcp"),
