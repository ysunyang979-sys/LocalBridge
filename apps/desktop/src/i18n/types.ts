...
export interface I18nDictionary {
  ...
  aiConnections: {
    ...
    availableClientsSection: string;
    apiModelsSection: string;
    customSection: string;
    noConnectedClients: string;
    noConnectedClientsDesc: string;
    categoryNativeMcp: string;
    categoryToolAdapter: string;
    categoryDescNativeMcp: string;
