...
export const CollectionDetailDrawer: React.FC<CollectionDetailDrawerProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-2xl h-full bg-white dark:bg-[#0d1320] border-l border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col min-w-0 animate-in slide-in-from-right duration-200"
