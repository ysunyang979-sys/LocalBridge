import type { GitBranchCreateParams, GitBranchCreateResult } from "@localbridge/protocol";
...
export function createGitBranchCreateHandler(
  ...
  return async (params: GitBranchCreateParams): Promise<GitBranchCreateResult> => {
    ...
    if (evalResult.decision === "deny") {
      throw new LocalBridgeError(
        ...
        evalResult.reason || `Operation "git.branchCreate" denied by policy.`
      );
    }
